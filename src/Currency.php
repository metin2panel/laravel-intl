...
class Currency extends Intl
{
     ...
     * @return mixed|string
     */
    public function format($number, $currencyCode = null, $options = [])
    {
        return $this->formatter()->format($number, $currencyCode ?: config('app.currency', 'TRY'),
     ...
     * @return mixed|string
     */
    public function formatAccounting($number, $currencyCode = null, $options = [])
    {
        return $this->formatter()->format($number, $currencyCode ?: config('app.currency', 'TRY'),
     ...
     * @return mixed|string
     */
    public function parse($number, $currencyCode = null, $options = [])
    {
        return $this->formatter()->parse($number, $currencyCode ?: config('app.currency', 'TRY'),
            $this->mergeOptions($options)
        );
    }
